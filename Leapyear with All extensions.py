#Print the calendar if it is a leap year check if you can print the calendar only for the month of February If 29th falls on a saturday or a sunday, print a message that it is a holiday, else print it's a weekday
import calendar
year=int(input())
month=int(input())
date=int(input())
...
#leapyear to check that what is next leap year
def findtheleapyear():
